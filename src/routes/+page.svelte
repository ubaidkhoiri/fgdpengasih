...
@media(max-width:760px){.navlinks{gap:10px}.navlinks a:nth-child(2){display:none}.hero{padding-top:35px}.hero-grid{grid-template-columns:1fr}.statbox{min-height:135px}.steps{grid-template-columns:1fr}.step{display:grid;grid-template-columns:auto 1fr;column-gap:12px;align-items:start}.step-num{grid-row:span 3}.step h3{margin-top:0}.role-grid{grid-template-columns:1fr}.role{display:grid;grid-template-columns:auto 1fr;column-gap:12px;align-items:start;padding:14px}.symbol{grid-row:span 3}.role h3{margin:0;font-size:16px}.role p{margin:2px 0 6px;font-size:13.5px}.role ul{margin:0;padding-left:16px;font-size:13px}.role li{margin-bottom:2px}.topics{grid-template-columns:repeat(2,1fr)}.fields{grid-template-columns:1fr}.field textarea{min-height:150px}.field .hint{min-height:0}.example-grid{grid-template-columns:1fr}.checklist{grid-template-columns:1fr}.section-head{align-items:start;flex-direction:column}.worksheet{padding:15px}.meta{grid-template-columns:1fr}}
