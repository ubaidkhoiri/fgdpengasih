...
<button type="button" class="menu-btn" onclick={toggleMenu} aria-label="Menu" aria-expanded={menuOpen} aria-haspopup="true">Menu</button>
{#if menuOpen}
