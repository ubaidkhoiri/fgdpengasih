<header class="topbar"><div class="wrap nav"><div class="brand">SEMALAM <span>SUNTUK SERMO</span></div><nav class="navlinks" aria-label="Navigasi utama"><a href="#alur">Alur FGD</a><a href="#peran">Peran</a><a href="#lembar">Lembar hasil</a></nav></div></header>
<main>
